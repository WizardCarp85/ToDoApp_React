  ...
  return (
    <div>
      ...
      <div
        ...
        data-aos="fade-up"
      >
        <h1 className="heading-text text-3xl md:text-[3rem] font-semibold md:font-bold text-[#e2e2e2] font-['Playfair_Display']">
          What&apos;s Pixel Planner?
        </h1>
      </div>
      {/* info */}
      <div
        className="info flex flex-col items-center justify-center text-[#D1D5DB] mx-[3em] text-center gap-8 mb-[8em] text-[0.8rem] md:text-lg md:mx-[20em] md:gap-12"
        data-aos="fade-up"
      >
      ...
      <div className="extrainfo" data-aos="fade-up">
        ...
        <div className="my-12 mx-8 text-[0.8rem] md:text-lg text-center">
