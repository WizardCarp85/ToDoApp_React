...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row justify-around">
      {/* Logo */}
      <div className="fixed md:flex z-100 md:justify-between md:items-center w-[99.8%] top-0 bg-[#0F0F0F]/90 h-[86px] md:h-24 pt-1 pl-8 md:pl-12 flex justify-between border-b-4 border-[#484848] rounded-b-xl">
        <Link
          href="/"
        ...
        <div className="hidden md:flex md:gap-16 text-[1.6rem] text-[#D8D8D8] font-semibold md:pr-16">
          <Link
            href="/home"
            className="hover:scale-[1.15] transition-transform duration-[400ms] ease-in-out hover:text-[#0099ff]"
          >
            Home
          </Link>
          <Link
      ...
      {/* mobile navbar menu*/}
      <div
        className={`fixed right-0 z-50 md:hidden w-[70%] h-screen bg-[#0c0c0c]/96 rounded-l-3xl pt-8 pl-10 transition-transform duration-500 ease-in-out ${
          menuOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
        <div className="flex justify-left items-top h-screen pt-8 pl-3 rounded-l-3xl">
